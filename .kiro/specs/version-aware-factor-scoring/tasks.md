...
- [x] 8.1 Extend the stream to 2026-06 — the post-cutoff natural experiment (data-v3)
  ...
  - Observable: extended artifacts span 2019-01..2026-06 with ~90 rebalances; the split table reports premium/effect-size separately for in-training vs post-cutoff; data-v3 published with the same asset naming; research.md gains exactly one new entry
  - _Requirements: 7.1, 7.2, 7.5, 8.5 (amendment scope: post-cutoff validation of the contamination signal)_
  - _Boundary: new script(s) under scripts/ + notebook edits ONLY as new cells appended to nb13/nb14 or a new nb15 (implementer choice, additive); data/ additions; no changes to macro_framework/ or workbook/ beyond regenerated gitignored outputs_
